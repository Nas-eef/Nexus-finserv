...
import log from '../navbar/imgss/log.png'
            ...
            <div class="bg-dark p-4" className="bootstrp-nav-drpdown">
              ...
              <div className="menu-cmpnys-div">
                ...
                <div className="cmpnys-sub-div">
                  ...
                  <h5 className="cmpnys-p">Find the Nexus finserve bracnch</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="container-fluid">
              ...
              <div className="nav-search-div">
                <input
                  ...
                  placeholder="Search nexusfinserv.in "
                />
        ...
        <div className="secnd-nav">
          <div className="nav-hover-div">
            ...
            <div className="dropdown3">
              <p className="drop-p">Nexus mall</p>
              <img src={arrow} className="dropdown-icon1" />
            ...
            <div className="dropdown4">
              ...
              <div className="dropdown-content-4">
                ...
                <Link to="./Card">
                  <button className="nav-hover-bt">Nexus finserv</button>{" "}
                </Link>
              </div>
            </div>
            ...
            <div className="dropdown8">
              ...
              <div className="dropdown-content-8">
                ...
                <Link to="./Card">
                  <button className="nav-hover-bt">Nexus loans</button>{" "}
                </Link>
                <Link to="./Card">
